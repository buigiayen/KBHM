...
export const Question = [
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        Key: "3.6",
        value:
          "Quan hệ tình dục với người nhiễm HIV hoặc người có nguy cơ nhiễm HIV",
        ShowText: true,
      },
      {
        Key: "3.7",
  ...
  },
  {
    Key: 5,
    value:
      "5. Anh/Chị là đối tượng hưởng trợ cấp tàn tật hoặc trợ cấp tàn tật hoặc nạn nhân chất độc màu da cam?",
    data: [
      {
        Key: "5.1",
        value:
          "Anh/Chị là đối tượng hưởng trợ cấp tàn tật hoặc trợ cấp tàn tật hoặc nạn nhân chất độc màu da cam?",
        ShowText: false,
      },
    ],
  ...
  },
  {
    Key: 6,
    value:
      "6. (câu hỏi dành cho nữ) Chị đang có thai hoặc nuôi con dưới 12 tháng tuổi?",
    data: [
      {
        Key: "6.1",
        value:
          "(câu hỏi dành cho nữ) Chị đang có thai hoặc nuôi con dưới 12 tháng tuổi?",
        ShowText: false,
      },
    ],
